...
Original file is located at
    https://colab.research.google.com/drive/1vIsbW2xQJRTVY6JrbiBbBzd4Ca6pQ7rj
"""
...
df_output = pd.DataFrame(cat_encoder.transform(df_test_unknow), columns=cat_encoder.get_feature_names_out(), index=df_test_unknow.index)
...
lin_mse = mean_squared_error(housing_labels, housing_predictions)  # Get MSE
lin_rmse = lin_mse ** 0.5  # Take the square root to get RMSE
print(lin_rmse)
...
"""## Replacing the GridSearchCV with a RandomizedSearchCV"""
